  ...
  return (
    <DashboardLayout>
      <div className="space-y-4">
        <div>
          <h1 className="text-xl md:text-2xl font-bold text-foreground">Transport</h1>
          <p className="text-xs md:text-sm text-muted-foreground">Your child's bus route and pickup details</p>
        </div>
