  ...
  return (
    <MobileLayout title="My Queries" showBack>
      <div className="p-4 space-y-3">
        <Drawer open={isOpen} onOpenChange={setIsOpen}>
          ...
          <DrawerContent className="max-h-[90dvh]">
            <DrawerHeader className="pb-2"><DrawerTitle>New Query</DrawerTitle></DrawerHeader>
      ...
      <Drawer open={!!selected} onOpenChange={() => setSelected(null)}>
        <DrawerContent className="max-h-[90dvh]">
          <DrawerHeader className="pb-2"><DrawerTitle className="text-left">{selected?.subject}</DrawerTitle></DrawerHeader>
