  ...
  return (
    <MobileLayout title="Feedback" showBack>
      <div className="p-4 space-y-3">
        <Drawer open={isOpen} onOpenChange={setIsOpen}>
          ...
          <DrawerContent className="max-h-[85dvh]">
            <DrawerHeader className="pb-2"><DrawerTitle>Submit Feedback</DrawerTitle></DrawerHeader>
            <div className="overflow-y-auto flex-1 min-h-0 space-y-5 px-4 pb-6">
              ...
              <div className="space-y-2">
                ...
                <Textarea placeholder="Share your thoughts..." value={message} onChange={e => setMessage(e.target.value)} className="min-h-[120px] text-base" />
              </div>
              <Button className="w-full h-12 text-base" onClick={handleSubmit} disabled={submitFeedback.isPending || !rating || !message.trim()}>
      ...
      <Drawer open={!!selectedFb} onOpenChange={() => setSelectedFb(null)}>
        <DrawerContent className="max-h-[85dvh]">
          <DrawerHeader className="pb-2"><DrawerTitle>Feedback Details</DrawerTitle></DrawerHeader>
          <div className="overflow-y-auto flex-1 min-h-0 space-y-4 px-4 pb-6">
            {selectedFb && (
              <>
