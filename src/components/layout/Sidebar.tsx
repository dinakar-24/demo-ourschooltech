...
const schoolAdminGrouped: MenuGroup[] = [
  ...
  },
  {
    ...
    items: [
      { label: 'Vehicles', path: '/fleet-vehicles', icon: Bus },
      { label: 'Drivers', path: '/fleet-drivers', icon: Users },
      { label: 'Routes & Stops', path: '/fleet-routes', icon: Bus },
      { label: 'Live Tracking', path: '/fleet-tracking', icon: Bus },
      { label: 'Trip Logs', path: '/fleet-trips', icon: ClipboardList },
      { label: 'Hostel', path: '/hostel', icon: Building2 },
      { label: 'Library', path: '/library', icon: BookOpen },
      { label: 'Inventory', path: '/inventory', icon: Package },
      { label: 'Visitors', path: '/visitors', icon: DoorOpen },
      { label: 'Medical', path: '/medical', icon: HeartPulse },
      { label: 'Staff & HR', path: '/staff-hr', icon: Users },
      { label: 'Payroll', path: '/payroll', icon: Wallet },
      { label: 'Admissions', path: '/admissions', icon: GraduationCap },
      { label: 'Finance Analytics', path: '/finance', icon: LineChart },
      ...
      { label: 'Biometric', path: '/biometric', icon: ScanFace },
      { label: 'Learning (LMS)', path: '/lms', icon: Library },
      { label: 'Online Exams', path: '/online-exams', icon: FileQuestion },
