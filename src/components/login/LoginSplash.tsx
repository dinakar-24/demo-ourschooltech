      ...
      >
        ...
        <motion.div variants={item} className="mb-4">
          <div className="relative w-72 h-56 mx-auto">
            ...
            />
            {/* Couch */}
            <motion.svg viewBox="0 0 280 110" className="absolute bottom-2 left-0 w-full" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4, duration: 0.7 }}>
              ...
              <motion.rect x="75" y="38" width="48" height="32" rx="8" fill="hsl(45 90% 62%)" animate={{ rotate: [-2, 2, -2] }} transition={{ duration: 3, repeat: Infinity, ease: 'easeInOut' }} />
              ...
              <motion.g transform="translate(8,42)" animate={{ rotate: [0, 3, 0] }} transition={{ duration: 4, repeat: Infinity, ease: 'easeInOut' }}>
              ...
              <motion.g transform="translate(238,42)" animate={{ rotate: [0, -3, 0] }} transition={{ duration: 4.5, repeat: Infinity, ease: 'easeInOut', delay: 1 }}>
            ...
            {/* Male graduate */}
            <motion.svg viewBox="0 0 80 165" className="absolute bottom-0 left-[14%] w-[72px] h-[140px]" initial={{ opacity: 0, x: -40 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.25, type: 'spring', damping: 16, stiffness: 120 }}>
            ...
            {/* Female graduate */}
            <motion.svg viewBox="0 0 80 165" className="absolute bottom-0 right-[14%] w-[72px] h-[140px]" initial={{ opacity: 0, x: 40 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.35, type: 'spring', damping: 16, stiffness: 120 }}>
              <ellipse cx="40" cy="158" rx="18" ry="4" fill="hsl(230 50% 35% / 0.3)" />
            ...
            {/* Floating badges */}
            <motion.div className="absolute top-2 left-[38%]" animate={{ y: [0, -10, 0], rotate: [0, 8, 0] }} transition={{ duration: 3, repeat: Infinity, ease: 'easeInOut' }}>
            ...
            <motion.div className="absolute top-6 right-2" animate={{ y: [0, -6, 0], rotate: [-5, 5, -5] }} transition={{ duration: 4, repeat: Infinity, ease: 'easeInOut', delay: 1 }}>
              <svg width="28" height="28" viewBox="0 0 28 28" fill="none"><rect x="2" y="4" width="24" height="20" rx="3" fill="hsl(350 65% 55% / 0.4)" /><rect x="4" y="6" width="20" height="16" rx="2" fill="hsl(350 65% 55% / 0.6)" /><line x1="14" y1="6" x2="14" y2="22" stroke="white" strokeWidth="1" opacity="0.5" /></svg>
            </motion.div>
            <motion.div className="absolute bottom-12 right-0" animate={{ y: [0, -5, 0], scale: [1, 1.1, 1] }} transition={{ duration: 3.5, repeat: Infinity, ease: 'easeInOut', delay: 0.5 }}>
